...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'future-center-students', loadComponent: () => import('./pages/future-center-students/future-center-students.component').then(m => m.FutureCenterStudentsComponent) },
      ...
      { path: 'enrollments',       loadComponent: () => import('./pages/enrollments/enrollments.component').then(m => m.EnrollmentsComponent) },
